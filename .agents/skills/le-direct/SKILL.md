...
Ao atingir readiness, use enrichment/finalization, rode gate `PROMPT_COMPILE`, gere prompt imutável e calcule a recomendação de `PROMPT_EXECUTION` pela complexidade do prompt real.
